...
const ResultEntryPage = () => {
  ...
  const handlePrintReport = async () => {
    ...
    try {
      const result = await generateCombinedLabReports(buildVisitDataForPdf(), getProfiles(), {
        download: false,
        print: true
      });
      if (result?.success) {
        ...
        <div className="share-modal-overlay" onClick={() => setShowShareOptions(false)}>
          <div className="share-modal-premium" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="share-options-grid">
              <Button variant="primary" onClick={handleDownloadReportPdf} icon={Download} fullWidth>
                Download PDF
              </Button>
