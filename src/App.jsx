    ...
    const initializeApp = async () => {
      try {
        ...
        try {
          ...
          // Only enable sync if database is configured
          if (healthCheck.dbConfigured) {
            ...
            console.log('ℹ️ Database not configured - running in local-only mode');
            console.log('💡 To enable sync, configure MONGODB_URI in your environment');
          }
        } catch (apiError) {
